...
#include <stdio.h>              // Required for: FILE, fopen_s(), fclose(), fprintf(), feof(), fscanf(), vsprintf() [GuiLoadStyle(), GuiLoadIcons()]
...
void GuiLoadStyle(const char *fileName)
{
    ...
    FILE *rgsFile = fopen_s(fileName, "rt");
...
char **GuiLoadIcons(const char *fileName, bool loadIconsName)
{
    ...
    FILE* rgiFile = fopen_s(fileName, "rb");
